...
const appRoutes: Routes = [
    ...
    {path: 'new-project', component: ProjectConfigComponent, canDeactivate: [CanDeactivateGuard]},
    {path: 'edit-project/:index', component: ProjectConfigComponent, canDeactivate: [CanDeactivateGuard]},
